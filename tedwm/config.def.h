...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_comma,  focusmon,       {.i = -1 } }, // Move focus forward one monitor
	{ MODKEY,                       XK_period, focusmon,       {.i = +1 } },
	{ MODKEY|ShiftMask,             XK_comma,  tagmon,         {.i = -1 } }, // Move focussed window forward one monitor
